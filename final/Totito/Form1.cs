...
namespace Totito
{
    ...
    {
        public string[,] tablero = new string[5, 5];
        public string tiro = "X";
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            if (VerificarLineas(botonElegido.Name, tablero))
            {
        ...
        public bool VerificarLineas(string name, string [,] tablero)
        {
